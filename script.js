document.addEventListener('DOMContentLoaded', function() {
    ...
    if (achievementsCarousel) {
        ...
        const achievementIndicatorsContainer = achievementsCarousel.querySelector('.carousel-indicators');
        ...
        function updateAchievementIndicators() {
            const indicators = Array.from(achievementIndicatorsContainer.children);
            indicators.forEach((indicator, index) => {
                indicator.classList.toggle('active', index === achievementCurrentIndex);
            });
        }
        ...
        achievementCards.forEach((_, index) => {
            ...
            indicator.classList.add('carousel-indicator');
            indicator.addEventListener('click', () => {
                achievementCurrentIndex = index;
                updateAchievementTrack();
            });
            achievementIndicatorsContainer.appendChild(indicator);
        });
